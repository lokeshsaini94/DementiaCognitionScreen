...
public class Module04Activity extends AppCompatActivity {
    ...
    private void startAudioRecorder() {
        String outputFile = Environment.getExternalStorageDirectory().getAbsolutePath() + "/Dementia Cognition Screen/" + GlobalVariables.userID + "_" + GlobalVariables.userInitials + "/06 - Task 04 Recording.mp3";
    ...
    private void nextModule() {
        ...
        if (GlobalVariables.modulesSelected[4]) {
            ...
            Intent intentModulesActivity = new Intent(Module04Activity.this, Module07Activity.class);
            Module04Activity.this.startActivity(intentModulesActivity);
