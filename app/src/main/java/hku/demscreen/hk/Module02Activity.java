...
public class Module02Activity extends AppCompatActivity {
    ...
    private final String Tag = Module02Activity.class.getSimpleName();
    private Vibrator vibrator;

    private String fileName = "04 - Task 02 Question 1";
    ...
    private void nextModule() {
        if (GlobalVariables.modulesSelected[2]) {
            ...
            Intent intentModulesActivity = new Intent(Module02Activity.this, Module07Activity.class);
            Module02Activity.this.startActivity(intentModulesActivity);
